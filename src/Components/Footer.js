...
export default function Footer() {
  return (
    <>
        <footer className="p-4 md:pt-16 md:pl-16 md:pr-16 bg-white sm:p-6 dark:bg-gray-800">
        ...
        <li className="mb-4">
        <a href="https://flowbite.com" className="hover:underline">Careers</a>
        </li>
        <li className="mb-4">
        <a href="https://flowbite.com" className="hover:underline">Employer home</a>
        </li>
        <li>
        <a href="https://tailwindcss.com/" className="hover:underline">Sitemap</a>
        </li>
        </ul>
        </div>
        <div>
        ...
        <li className="mb-4">
        <a href="https://github.com/themesberg/flowbite" className="hover:underline ">Summons/Notices</a>
        </li>
        <li className="mb-4">
        <a href="https://github.com/themesberg/flowbite" className="hover:underline ">Grievances</a>
        </li>
        <li>
        <a href="https://discord.gg/4eeurUVvTy" className="hover:underline">Report issue</a>
        </li>
        </ul>
        </div>
        <div>
        <ul className="hidden md:block text-gray-600 dark:text-gray-400">
        <li className="mb-4">
        ...
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://JobsJobs.com" className="hover:underline">JobsJobs.com™</a>. All Rights Reserved.
        </span>
